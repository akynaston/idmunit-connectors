...
/**
 * Implements SCPConnector functionality to push files to UNIX IDM servers (created for use with the DTF connector)
 *
 * @author Brent Kynaston, Software Engineer, TriVir LLC
 * @version %I%, %G%
 */
public class WinSCPLib {
    public static void scpSendFile(String winSCPExecutable, String winSCPProfileID, String localSCPScriptFile, String localTargetFile, String destinationPath, String fileRDN) {
        System.out.println("\n...executing push of file to server profile: " + winSCPProfileID);
